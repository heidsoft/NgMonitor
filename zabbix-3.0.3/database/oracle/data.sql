...
INSERT INTO actions (actionid,name,eventsource,evaltype,status,esc_period,def_shortdata,def_longdata,recovery_msg,r_shortdata,r_longdata,formula) values ('3','Report problems to Zabbix administrators','0','0','1','3600','{TRIGGER.STATUS}: {TRIGGER.NAME}','Trigger: {TRIGGER.NAME}' || chr(13) || chr(10) || 'Trigger status: {TRIGGER.STATUS}' || chr(13) || chr(10) || 'Trigger severity: {TRIGGER.SEVERITY}' || chr(13) || chr(10) || 'Trigger URL: {TRIGGER.URL}' || chr(13) || chr(10) || '' || chr(13) || chr(10) || 'Item values:' || chr(13) || chr(10) || '' || chr(13) || chr(10) || '1. {ITEM.NAME1} ({HOST.NAME1}:{ITEM.KEY1}): {ITEM.VALUE1}' || chr(13) || chr(10) || '2. {ITEM.NAME2} ({HOST.NAME2}:{ITEM.KEY2}): {ITEM.VALUE2}' || chr(13) || chr(10) || '3. {ITEM.NAME3} ({HOST.NAME3}:{ITEM.KEY3}): {ITEM.VALUE3}' || chr(13) || chr(10) || '' || chr(13) || chr(10) || 'Original event ID: {EVENT.ID}','1','{TRIGGER.STATUS}: {TRIGGER.NAME}','Trigger: {TRIGGER.NAME}' || chr(13) || chr(10) || 'Trigger status: {TRIGGER.STATUS}' || chr(13) || chr(10) || 'Trigger severity: {TRIGGER.SEVERITY}' || chr(13) || chr(10) || 'Trigger URL: {TRIGGER.URL}' || chr(13) || chr(10) || '' || chr(13) || chr(10) || 'Item values:' || chr(13) || chr(10) || '' || chr(13) || chr(10) || '1. {ITEM.NAME1} ({HOST.NAME1}:{ITEM.KEY1}): {ITEM.VALUE1}' || chr(13) || chr(10) || '2. {ITEM.NAME2} ({HOST.NAME2}:{ITEM.KEY2}): {ITEM.VALUE2}' || chr(13) || chr(10) || '3. {ITEM.NAME3} ({HOST.NAME3}:{ITEM.KEY3}): {ITEM.VALUE3}' || chr(13) || chr(10) || '' || chr(13) || chr(10) || 'Original event ID: {EVENT.ID}','')
/

INSERT INTO actions (actionid,name,eventsource,evaltype,status,esc_period,def_shortdata,def_longdata,recovery_msg,r_shortdata,r_longdata,formula) values ('4','Report not supported items','3','0','1','3600','{ITEM.STATE}: {HOST.NAME}:{ITEM.NAME}','Host: {HOST.NAME}' || chr(13) || chr(10) || 'Item: {ITEM.NAME}' || chr(13) || chr(10) || 'Key: {ITEM.KEY}' || chr(13) || chr(10) || 'State: {ITEM.STATE}','1','{ITEM.STATE}: {HOST.NAME}:{ITEM.NAME}','Host: {HOST.NAME}' || chr(13) || chr(10) || 'Item: {ITEM.NAME}' || chr(13) || chr(10) || 'Key: {ITEM.KEY}' || chr(13) || chr(10) || 'State: {ITEM.STATE}','')
/

INSERT INTO actions (actionid,name,eventsource,evaltype,status,esc_period,def_shortdata,def_longdata,recovery_msg,r_shortdata,r_longdata,formula) values ('5','Report not supported low level discovery rules','3','0','1','3600','{LLDRULE.STATE}: {HOST.NAME}:{LLDRULE.NAME}','Host: {HOST.NAME}' || chr(13) || chr(10) || 'Low level discovery rule: {LLDRULE.NAME}' || chr(13) || chr(10) || 'Key: {LLDRULE.KEY}' || chr(13) || chr(10) || 'State: {LLDRULE.STATE}','1','{LLDRULE.STATE}: {HOST.NAME}:{LLDRULE.NAME}','Host: {HOST.NAME}' || chr(13) || chr(10) || 'Low level discovery rule: {LLDRULE.NAME}' || chr(13) || chr(10) || 'Key: {LLDRULE.KEY}' || chr(13) || chr(10) || 'State: {LLDRULE.STATE}','')
/

INSERT INTO actions (actionid,name,eventsource,evaltype,status,esc_period,def_shortdata,def_longdata,recovery_msg,r_shortdata,r_longdata,formula) values ('6','Report unknown triggers','3','0','1','3600','{TRIGGER.STATE}: {TRIGGER.NAME}','Trigger name: {TRIGGER.NAME}' || chr(13) || chr(10) || 'Expression: {TRIGGER.EXPRESSION}' || chr(13) || chr(10) || 'State: {TRIGGER.STATE}','1','{TRIGGER.STATE}: {TRIGGER.NAME}','Trigger name: {TRIGGER.NAME}' || chr(13) || chr(10) || 'Expression: {TRIGGER.EXPRESSION}' || chr(13) || chr(10) || 'State: {TRIGGER.STATE}','')
/
...
INSERT INTO triggers (triggerid,expression,description,url,status,priority,comments,templateid,type,flags) values ('13557','{13160}=1','Zabbix value cache working in low memory mode','','0','4','',NULL,'0','0')
/
...
INSERT INTO triggers (triggerid,expression,description,url,status,priority,comments,templateid,type,flags) values ('13558','{13161}=1','Zabbix value cache working in low memory mode','','0','4','','13557','0','0')
/
